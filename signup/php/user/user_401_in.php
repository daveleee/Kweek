...
?>
    <!--서버 업로드시 수정해야 할 부분-->
		<option value="http://www.kweeknyc.com/signup/php/user/user_401_in.php?res_name=<?php echo $res_name;
          ...
          onclick="if(<?php echo $qr;?> <= '0'){myFunc()}else{myFunc2()}"> 
            ...
            <script>
              function myFunc() {
                ...
                location.replace('../user/user_401.php');
              }

              function myFunc2() {
                location.replace('../user/user_401_update.php?qr_index=<?php echo $qr_index; ?>&qr=<?php echo $qr; ?>&res_number=<?php echo $res_number; ?>');
              }
            </script>
