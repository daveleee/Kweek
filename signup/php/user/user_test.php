...
<?php
	require_once('/home/kweek/kweeknyc.com/signup/config.php');  //서버 업로드시 수정해야할 부분.
?>
...
<?php
  ...
  $sql2="SELECT qr_index FROM kweeknyc.tbl_qrcode WHERE qr_index='21';";  //서버 업로드시 qr_index 수정할것
...
?>
    <!--서버 업로드시 수정할 것-->
		<option value="http://www.kweeknyc.com/signup/php/user/user_test_in.php?res_name=<?php echo $res_name;
